class Game {
  ...
  start() {
    ...
    car1.addImage("car1.2", boomImg);
    car1.scale = 0.07;

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.addImage("car1.2", boomImg);
    car2.scale = 0.07;
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if(life <= 0){
          cars[index - 1].changeImage("car1.2", boomImg);
        }
  ...
  handlePlayerControls() {
    ...
    if (keyIsDown(RIGHT_ARROW) && player.positionX < width / 2 + 300 && player.life > 0) {
      this.leftKeyActive = false;
      player.positionX += 5;
      player.update();
    }
